...
> **Note (2026-09-15):** "(sprint-9)" in the title is the heading hard-coded in `benchmarks/run_4way_interleaved.py`, not the measurement round. This report measures sprint-10: it was added by commit 6368ec16, the change that drops the per-instance `__keys__` tracking.
