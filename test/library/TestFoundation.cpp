...
TEST_F(FoundationTest, OsEnviron) {
    ...
    const proto::ProtoObject* osMod = env.resolve("os");
    ASSERT_NE(osMod, nullptr);
    const proto::ProtoObject* fileVal = osMod->getAttribute(ctx, proto::ProtoString::fromUTF8String(ctx, "__file__"));
    EXPECT_TRUE(fileVal != nullptr && fileVal->isString(ctx));
}
...
TEST_F(FoundationTest, ArgparseBasic) {
    ...
    const proto::ProtoObject* fileVal = apMod->getAttribute(ctx, proto::ProtoString::fromUTF8String(ctx, "__file__"));
    EXPECT_TRUE(fileVal != nullptr && fileVal->isString(ctx));
}
