...
static const proto::ProtoObject* py_count_next(
    ...
    const proto::ProtoObject* cur = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_cur__"));
    const proto::ProtoObject* step = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_step__"));
    ...
    self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_cur__"), ctx->fromInteger(v + s));
...
static const proto::ProtoObject* py_count(
    ...
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* c = proto->newChild(ctx, true);
    c = c->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_cur__"), ctx->fromInteger(start));
    c = c->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_step__"), ctx->fromInteger(step));
    return c;
}
...
static const proto::ProtoObject* py_islice_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* it = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_it__"));
    const proto::ProtoObject* stopObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_stop__"));
    const proto::ProtoObject* idxObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_idx__"));
    ...
    self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_idx__"), ctx->fromInteger(idx + 1));
    return val;
}
...
static const proto::ProtoObject* py_islice(
    ...
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* sl = proto->newChild(ctx, true);
    sl = sl->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_it__"), it);
    sl = sl->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_stop__"), ctx->fromInteger(stop));
    sl = sl->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_idx__"), ctx->fromInteger(start));
    return sl;
}
...
static const proto::ProtoObject* py_chain_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* itersObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_iters__"));
    const proto::ProtoObject* idxObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_idx__"));
    ...
    while (static_cast<unsigned long>(idx) < n) {
        ...
        const proto::ProtoObject* nextM = it ? it->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__")) : nullptr;
        if (!nextM || !nextM->asMethod(ctx)) {
            idx++;
            self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_idx__"), ctx->fromInteger(idx));
            continue;
        }
        const proto::ProtoObject* val = nextM->asMethod(ctx)(ctx, it, nullptr, ctx->newList(), nullptr);
...
static const proto::ProtoObject* py_repeat_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* obj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_obj__"));
    const proto::ProtoObject* timesObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_times__"));
    const proto::ProtoObject* countObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_count__"));
    ...
    if (timesObj != PROTO_NONE && timesObj->isInteger(ctx)) {
        ...
        self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_count__"), ctx->fromInteger(count + 1));
    }
    return obj;
}
...
static const proto::ProtoObject* py_repeat(
    ...
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* r = proto->newChild(ctx, true);
    r = r->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_obj__"), obj);
    r = r->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_times__"), times ? times : PROTO_NONE);
    r = r->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_count__"), ctx->fromInteger(0));
    return r;
}
...
static const proto::ProtoObject* py_cycle_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* it = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_it__"));
    const proto::ProtoObject* cacheObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_cache__"));
    const proto::ProtoObject* idxObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_idx__"));
    ...
    if (idx < static_cast<long long>(cache->getSize(ctx))) {
        ...
        self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_idx__"), ctx->fromInteger(idx + 1));
        return val;
    }
    const proto::ProtoObject* nextM = it->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"));
    if (!nextM || !nextM->asMethod(ctx)) return nullptr;
    ...
    if (!val || val == PROTO_NONE) {
        ...
        self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_idx__"), ctx->fromInteger(1));
        return cache->getAt(ctx, 0);
    }
    const proto::ProtoList* newCache = cache->appendLast(ctx, val);
    self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_cache__"), newCache->asObject(ctx));
    self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_idx__"), ctx->fromInteger(newCache->getSize(ctx)));
    return val;
}
...
static const proto::ProtoObject* py_cycle(
    ...
    const proto::ProtoObject* it = iterM->asMethod(ctx)(ctx, iterable, nullptr, ctx->newList(), nullptr);
    if (!it) return PROTO_NONE;
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* c = proto->newChild(ctx, true);
    c = c->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_it__"), it);
    c = c->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_cache__"), ctx->newList()->asObject(ctx));
    c = c->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_idx__"), ctx->fromInteger(0));
    return c;
}
...
static const proto::ProtoObject* py_takewhile_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* pred = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__takewhile_pred__"));
    const proto::ProtoObject* it = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__takewhile_it__"));
...
static const proto::ProtoObject* py_takewhile(
    ...
    const proto::ProtoObject* it = iterM->asMethod(ctx)(ctx, iterable, nullptr, ctx->newList(), nullptr);
    if (!it) return PROTO_NONE;
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__takewhile_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* tw = proto->newChild(ctx, true);
    tw = tw->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__takewhile_pred__"), pred);
    tw = tw->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__takewhile_it__"), it);
    return tw;
}
...
static const proto::ProtoObject* py_dropwhile_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* pred = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_pred__"));
    const proto::ProtoObject* it = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_it__"));
    ...
    for (;;) {
        ...
        const proto::ProtoObject* dropObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_dropping__"));
        ...
        if (!predTrue) {
            self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_dropping__"), ctx->fromInteger(0));
            return val;
        }
    }
}
...
static const proto::ProtoObject* py_dropwhile(
    ...
    const proto::ProtoObject* it = iterM->asMethod(ctx)(ctx, iterable, nullptr, ctx->newList(), nullptr);
    if (!it) return PROTO_NONE;
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* dw = proto->newChild(ctx, true);
    dw = dw->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_pred__"), pred);
    dw = dw->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_it__"), it);
    dw = dw->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_dropping__"), ctx->fromInteger(1));
    return dw;
}
...
static const proto::ProtoObject* empty_iterator(proto::ProtoContext* ctx, const proto::ProtoObject* self) {
    const proto::ProtoObject* chainM = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "chain"));
...
static const proto::ProtoObject* py_accumulate_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* it = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_it__"));
    const proto::ProtoObject* totalObj = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_total__"));
    const proto::ProtoObject* func = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_func__"));
    ...
    if (!totalObj || totalObj == PROTO_NONE) {
        ...
        self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_total__"), first);
        return first;
    }
    ...
    if (func && func != PROTO_NONE) {
        ...
        const proto::ProtoObject* callResult = func->call(ctx, nullptr, proto::ProtoString::createSymbol(ctx, "__call__"), func, args, nullptr);
    ...
    self->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_total__"), newTotal);
    return newTotal;
}
...
static const proto::ProtoObject* py_accumulate(
    ...
    const proto::ProtoObject* it = iterM->asMethod(ctx)(ctx, iterable, nullptr, ctx->newList(), nullptr);
    if (!it) return PROTO_NONE;
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accumulate_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* acc = proto->newChild(ctx, true);
    acc = acc->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_it__"), it);
    acc = acc->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_total__"), PROTO_NONE);
    acc = acc->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accum_func__"), func ? func : PROTO_NONE);
    return acc;
}
...
static const proto::ProtoObject* py_starmap_next(
    ...
    const proto::ProtoObject* self,
    const proto::ParentLink*, const proto::ProtoList*, const proto::ProtoSparseList*) {
    const proto::ProtoObject* func = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__starmap_func__"));
    const proto::ProtoObject* it = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__starmap_it__"));
    ...
    if (!args) {
        ...
        const proto::ProtoObject* iterM = argsObj->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"));
        if (iterM && iterM->asMethod(ctx)) {
            ...
            if (tempIt) {
                ...
                const proto::ProtoObject* nAttr = tempIt->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"));
    ...
    const proto::ProtoObject* callM = func->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__call__"));
...
static const proto::ProtoObject* py_starmap(
    ...
    const proto::ProtoObject* it = iterM->asMethod(ctx)(ctx, iterable, nullptr, ctx->newList(), nullptr);
    if (!it) return PROTO_NONE;
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__starmap_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* sm = proto->newChild(ctx, true);
    sm = sm->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__starmap_func__"), func);
    sm = sm->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__starmap_it__"), it);
    return sm;
}
...
static const proto::ProtoObject* py_chain(
    ...
    for (unsigned long i = 0; i < n; ++i) {
        ...
        const proto::ProtoObject* itAttr = iterable->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"));
    ...
    const proto::ProtoObject* proto = self->getAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_proto__"));
    if (!proto) return PROTO_NONE;
    const proto::ProtoObject* ch = proto->newChild(ctx, true);
    ch = ch->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_iters__"), iters->asObject(ctx));
    ch = ch->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_idx__"), ctx->fromInteger(0));
    return ch;
}
...
const proto::ProtoObject* initialize(proto::ProtoContext* ctx) {
    ...
    countProto = countProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(countProto), py_iter_self));
    countProto = countProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(countProto), py_count_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__count_proto__"), countProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "count"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_count));

    const proto::ProtoObject* isliceProto = ctx->newObject(false);
    isliceProto = isliceProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(isliceProto), py_iter_self));
    isliceProto = isliceProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(isliceProto), py_islice_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__islice_proto__"), isliceProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "islice"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_islice));

    const proto::ProtoObject* chainProto = ctx->newObject(false);
    chainProto = chainProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(chainProto), py_iter_self));
    chainProto = chainProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(chainProto), py_chain_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__chain_proto__"), chainProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "chain"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_chain));

    const proto::ProtoObject* repeatProto = ctx->newObject(false);
    repeatProto = repeatProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(repeatProto), py_iter_self));
    repeatProto = repeatProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(repeatProto), py_repeat_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__repeat_proto__"), repeatProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "repeat"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_repeat));

    const proto::ProtoObject* cycleProto = ctx->newObject(false);
    cycleProto = cycleProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(cycleProto), py_iter_self));
    cycleProto = cycleProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(cycleProto), py_cycle_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__cycle_proto__"), cycleProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "cycle"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_cycle));

    const proto::ProtoObject* takewhileProto = ctx->newObject(false);
    takewhileProto = takewhileProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(takewhileProto), py_iter_self));
    takewhileProto = takewhileProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(takewhileProto), py_takewhile_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__takewhile_proto__"), takewhileProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "takewhile"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_takewhile));

    const proto::ProtoObject* dropwhileProto = ctx->newObject(false);
    dropwhileProto = dropwhileProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(dropwhileProto), py_iter_self));
    dropwhileProto = dropwhileProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(dropwhileProto), py_dropwhile_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__dropwhile_proto__"), dropwhileProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "dropwhile"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_dropwhile));

    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "tee"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_tee));
    const proto::ProtoObject* accumulateProto = ctx->newObject(false);
    accumulateProto = accumulateProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(accumulateProto), py_iter_self));
    accumulateProto = accumulateProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(accumulateProto), py_accumulate_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__accumulate_proto__"), accumulateProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "accumulate"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_accumulate));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "groupby"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_groupby_stub));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "product"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_product_stub));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "combinations"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_combinations_stub));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "combinations_with_replacement"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_combinations_with_replacement_stub));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "permutations"),
    ...
    starmapProto = starmapProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__iter__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(starmapProto), py_iter_self));
    starmapProto = starmapProto->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__next__"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(starmapProto), py_starmap_next));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "__starmap_proto__"), starmapProto);
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "starmap"),
        ctx->fromMethod(const_cast<proto::ProtoObject*>(mod), py_starmap));
    mod = mod->setAttribute(ctx, proto::ProtoString::createSymbol(ctx, "batched"),
