...
static const proto::ProtoObject* py_type_get_mro(
    ...
    if (get_env_diag()) {
        fprintf(stderr, "DEBUG py_type_get_mro: falling back for %p\n", (void*)self);
    }
...
std::string PythonEnvironment::reprObject(proto::ProtoContext* context, const proto::ProtoObject* obj) {
    ...
    if (cls) {
        ...
        if (rawAttr && rawAttr != PROTO_NONE) {
            ...
            const proto::ProtoObject* getM = env ? env->getAttribute(context, env->getType(context, rawAttr), PythonEnvironment::getInternalString(context, "__get__")) : nullptr;
    ...
    if (std::getenv("PROTO_ENV_DIAG")) {
        ...
        if (cls) {
            const proto::ProtoObject* nameAttr = env ? env->getAttribute(context, cls, env->getNameString()) : cls->getAttribute(context, PythonEnvironment::getInternalString(context, "__name__"));
...
static const proto::ProtoObject* py_dict_call(
    ...
    if (positionalParameters && positionalParameters->getSize(context) >= 2) {
        ...
        if (d_data && d_keys && d_data->asSparseList(context) && d_keys->asList(context)) {
            ...
            const proto::ProtoString* keysS = env ? env->getKeysString() : PythonEnvironment::getInternedString(context, "keys");
                        ...
                        if (nextM && nextM != PROTO_NONE) {
                            for (;;) {
                                ...
                                if (pairL && pairL->getSize(context) == 2) {
                                    ...
                                    const proto::ProtoString* getIS = PythonEnvironment::getInternedString(context, "__getitem__");
...
static const proto::ProtoObject* py_set_union(
    ...
    result->setAttribute(context, PythonEnvironment::getInternalString(context, "__data__"), acc->asObject(context));
    return result;
}
...
static const proto::ProtoObject* py_frozenset_call(
    ...
    if (std::getenv("PROTO_ENV_DIAG")) {
        fprintf(stderr, "DEBUG_frozenset_call: obj=%p cls=%p clsS=%p\n", (void*)fs, (void*)cls, (void*)env->getClassString());
        if (fs->hasAttribute(context, env->getClassString())) {
            fprintf(stderr, "  - SUCCESSFULLY set __class__\n");
        } else {
            fprintf(stderr, "  - FAILED to set __class__\n");
        }
    }
    return fs;
}
...
static const proto::ProtoObject* py_str_startswith(
    ...
    if (env) {
        if (std::getenv("PROTO_ENV_DIAG")) {
            ...
            const proto::ProtoString* clsStr = PythonEnvironment::getInternedString(context, "__class__");
            const proto::ProtoString* nameStr = PythonEnvironment::getInternedString(context, "__name__");
...
static const proto::ProtoObject* py_dict_fromkeys(
    ...
    const proto::ProtoObject* nextM = itObj->getAttribute(context, PythonEnvironment::getInternalString(context, "__next__"));
    if (!nextM || !nextM->asMethod(context)) return PROTO_NONE;
...
void PythonEnvironment::raiseKeyError(proto::ProtoContext* ctx, const proto::ProtoObject* key) {
    ...
    if (exc && exc != PROTO_NONE) { std::string excName = "Exception"; if(exc && exc->hasAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__class__")) == PROTO_TRUE) { const proto::ProtoObject* cls = exc->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__class__")); if (cls->hasAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__name__")) == PROTO_TRUE) { cls->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__name__"))->asString(ctx)->toUTF8String(ctx, excName); } } fprintf(stderr, "DEBUG EXCEPTION: Raised %s exc=%p\n", excName.c_str(), (void*)exc); setPendingException(exc); } else { fprintf(stderr, "raiseTypeError FAILED exc=%p\n", exc); }
}
...
void PythonEnvironment::initializeRootObjects(const std::string& stdLibPath, const std::vector<std::string>& searchPaths) {
    ...
    intPrototype = space_->getSmallIntegerPrototype();
    strPrototype = space_->getStringPrototype();
    listPrototype = space_->getListPrototype();
    dictPrototype = space_->getSparseListPrototype();
    tuplePrototype = space_->getTuplePrototype();
    bytesPrototype = space_->getBytesPrototype();
    boolPrototype = space_->getBoolPrototype();
    floatPrototype = space_->getDoublePrototype();
    nonePrototype = space_->getNonePrototype();
    ...
    fprintf(stderr, "DEBUG BEFORE BUILTINS INIT: tupleProto=%p dictProto=%p strProto=%p\n", 
            (void*)tuplePrototype, (void*)dictPrototype, (void*)strPrototype);

    // builtins module
    fprintf(stderr, "DEBUG BEFORE BUILTINS INIT: tuple=%p dict=%p none=%p\n", (void*)tuplePrototype, (void*)dictPrototype, (void*)nonePrototype);
    fflush(stderr);
    ...
    registerNativeModule(nativeProviderPtr, "stat", [](proto::ProtoContext* ctx) { return stat_module::initialize(ctx); });
    ...
    dictPrototype = dictPrototype->setAttribute(rootContext_, basesString, rootContext_->newTupleFromList(rootContext_->newList()->appendLast(rootContext_, objectPrototype))->asObject(rootContext_));
    {
        const proto::ProtoSparseList* attrs = dictPrototype->getOwnAttributes(rootContext_);
        fprintf(stderr, "DEBUG_DICT_PROTO: dictPrototype=%p attrs=%p size=%lu mutable_ref=%lu\n", (void*)dictPrototype, (void*)attrs, (attrs ? attrs->getSize(rootContext_) : 0), (unsigned long)((const size_t*)dictPrototype)[3]);
    }
    ...
    auto setupCoreType = [&](const proto::ProtoObject*& proto) {
        ...
        if (std::getenv("PROTO_ENV_DIAG")) {
            fprintf(stderr, "DEBUG setupCoreType: proto=%p mro=%p isTuple=%d\n", (void*)proto, (void*)mro, mro->asTuple(rootContext_) != nullptr);
        }
        proto = const_cast<proto::ProtoObject*>(proto->setAttribute(rootContext_, mroString, mro));
        const proto::ProtoObject* mroCheck = proto->getAttribute(rootContext_, mroString);
        if (std::getenv("PROTO_ENV_DIAG")) {
            fprintf(stderr, "DEBUG setupCoreType: mroCheck=%p isTuple=%d\n", (void*)mroCheck, mroCheck->asTuple(rootContext_) != nullptr);
        }
    ...
    // 2. Synchronize final prototypes with the builtins module
    if (builtinsModule) {
        ...
        // Ensure __dict__ descriptor is available for types
    ...
    // Sync core prototypes back to space one last time to ensure consistency after builtins augmentation
    ...
    space_->objectPrototype = const_cast<proto::ProtoObject*>(objectPrototype);
    space_->typePrototype = const_cast<proto::ProtoObject*>(typePrototype);
    space_->intPrototype = const_cast<proto::ProtoObject*>(intPrototype);
    space_->stringPrototype = const_cast<proto::ProtoObject*>(strPrototype);
    space_->listPrototype = const_cast<proto::ProtoObject*>(listPrototype);
    space_->sparseListPrototype = const_cast<proto::ProtoObject*>(dictPrototype);
    space_->tuplePrototype = const_cast<proto::ProtoObject*>(tuplePrototype);
    space_->setPrototype = const_cast<proto::ProtoObject*>(setPrototype);
    space_->bytesPrototype = const_cast<proto::ProtoObject*>(bytesPrototype);
    space_->boolPrototype = const_cast<proto::ProtoObject*>(boolPrototype);
    space_->doublePrototype = const_cast<proto::ProtoObject*>(floatPrototype);
    space_->nonePrototype = const_cast<proto::ProtoObject*>(nonePrototype);
...
int PythonEnvironment::executeString(const std::string& source, const std::string& name) {
    ...
    if (mod == nullptr || mod == PROTO_NONE) {
        ...
        mod = mod->setAttribute(context, PythonEnvironment::getInternalString(context, "__name__"), mainName->asObject(context));
        ...
        if (modules) {
            ...
            sysModule = sysModule->setAttribute(context, PythonEnvironment::getInternedString(context, "modules"), newModules);
        }
    }
...
int PythonEnvironment::executeModule(const std::string& moduleName, bool asMain, proto::ProtoContext* ctx) {
    ...
    const proto::ProtoString* nameKey = PythonEnvironment::getInternalString(ctx, "__name__");
    const proto::ProtoString* pkgKey = PythonEnvironment::getInternalString(ctx, "__package__");
    if (asMain) {
        ...
        if (lastDot != std::string::npos) {
            mutableModObj->setAttribute(ctx, pkgKey, PythonEnvironment::getInternedString(ctx, moduleName.substr(0, lastDot).c_str())->asObject(ctx));
        } else {
...
const proto::ProtoObject* PythonEnvironment::getType(proto::ProtoContext* ctx, const proto::ProtoObject* obj) {
    if (std::getenv("PROTO_ENV_DEBUG")) {
        static bool hashesPrinted = false;
        if (!hashesPrinted) {
            hashesPrinted = true;
            fprintf(stderr, "TRACE: HASH __class__: %lu\n", (unsigned long)PythonEnvironment::getInternedString(ctx, "__class__")->getHash(ctx));
            fprintf(stderr, "TRACE: HASH __name__: %lu\n", (unsigned long)PythonEnvironment::getInternedString(ctx, "__name__")->getHash(ctx));
            fprintf(stderr, "TRACE: HASH __bases__: %lu\n", (unsigned long)PythonEnvironment::getInternedString(ctx, "__bases__")->getHash(ctx));
            fprintf(stderr, "TRACE: HASH __is_python_class__: %lu\n", (unsigned long)PythonEnvironment::getInternedString(ctx, "__is_python_class__")->getHash(ctx));
            fprintf(stderr, "TRACE: HASH __mro__: %lu\n", (unsigned long)PythonEnvironment::getInternedString(ctx, "__mro__")->getHash(ctx));
        }
        fprintf(stderr, "TRACE: getType(obj=%p)\n", (void*)obj);
    }
    ...
    // 1. Python-level __class__ (Explicit Identity)
    ...
    if (cls && cls != PROTO_NONE) {
        if (std::getenv("PROTO_ENV_DEBUG")) {
            std::string clsName = "unknown";
            const proto::ProtoObject* nameAttr = cls->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__name__"));
            if (nameAttr && nameAttr->isString(ctx)) nameAttr->asString(ctx)->toUTF8String(ctx, clsName);
            fprintf(stderr, "TRACE: getType(obj=%p) found __class__=%p ('%s')\n", (void*)obj, (void*)cls, clsName.c_str());
        }
        return cls;
    }

    // 2. Class/Type check using physical properties and Python markers
    const proto::ProtoString* clsS = this->getClassString();
    if (clsS) {
        const proto::ProtoObject* cls = obj->proto::ProtoObject::getAttribute(ctx, clsS);
        if (cls && cls != PROTO_NONE) return cls;
    }

    const proto::ProtoString* basesS = PythonEnvironment::getInternedString(ctx, "__bases__");
    if (obj->hasAttribute(ctx, basesS) == PROTO_TRUE) return getTypePrototype();

    const proto::ProtoString* nameS = PythonEnvironment::getInternedString(ctx, "__name__");
    if (obj->hasAttribute(ctx, nameS) == PROTO_TRUE) {
        // Distinguish between module and class
        const proto::ProtoString* pathS = PythonEnvironment::getInternedString(ctx, "__path__");
        if (obj->hasAttribute(ctx, pathS) == PROTO_TRUE) return getModulePrototype();
        
        const proto::ProtoString* loaderS = PythonEnvironment::getInternedString(ctx, "__loader__");
        if (obj->hasAttribute(ctx, loaderS) == PROTO_TRUE) return getModulePrototype();

        if (modulePrototype && obj->isInstanceOf(ctx, modulePrototype)) return getModulePrototype();
        
        return getTypePrototype();
    }

    // 3. Collection Heuristics (Structural Identity Fallback)
    
    // Check for wrapped data dictionary
    const proto::ProtoObject* data = obj->proto::ProtoObject::getAttribute(ctx, this->getDataString() ? this->getDataString() : PythonEnvironment::getInternedString(ctx, "__data__"));
    ...
    // 4. Physical Prototype Fallback (Instance model)
    ...
    if (std::getenv("PROTO_ENV_DEBUG")) {
        ...
        if (attrs) {
            fprintf(stderr, "TRACE: getType(%p) FAILED TO IDENTIFY. Own attributes:\n", (void*)obj);
            auto* it = const_cast<proto::ProtoSparseListIterator*>(attrs->getIterator(ctx));
            while (it && it->hasNext(ctx)) {
                unsigned long k = it->nextKey(ctx);
                fprintf(stderr, "  - Attr Hash: %lu\n", k);
                it = const_cast<proto::ProtoSparseListIterator*>(it->advance(ctx));
            }
        }
    }
...
const proto::ProtoObject* PythonEnvironment::getAttribute(proto::ProtoContext* ctx, const proto::ProtoObject* obj, const proto::ProtoString* name) {
    ...
    if (std::getenv("PROTO_ENV_DEBUG")) {
        fprintf(stderr, "TRACE: getAttribute(obj=%p, attr='%s')\n", (void*)obj, nameStr.c_str());
    }
    bool tracing = std::getenv("PROTO_ENV_DIAG") != nullptr;
    if (tracing) {
         fprintf(stderr, "DEBUG getAttribute: obj=%p attr=%s (namePtr=%p)\n", (void*)obj, nameStr.c_str(), (void*)name);
         if (obj && obj != PROTO_NONE) {
             const proto::ProtoObject* cls = this->getType(ctx, obj);
             std::string clsName = "<unknown>";
             if (cls) {
                 const proto::ProtoObject* nm = cls->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__name__"));
                 if (nm && nm->isString(ctx)) nm->asString(ctx)->toUTF8String(ctx, clsName);
             }
             fprintf(stderr, "  - obj class: %s\n", clsName.c_str());
             
             std::string objName = "unknown";
             const proto::ProtoObject* objNameAttr = obj->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__name__"));
             if (objNameAttr && objNameAttr->isString(ctx)) objNameAttr->asString(ctx)->toUTF8String(ctx, objName);
             if (objName == "_collections_abc") {
                 const proto::ProtoSparseList* attrs = obj->getAttributes(ctx);
                 if (attrs) {
                     fprintf(stderr, "  - _collections_abc attributes list:\n");
                     auto* it = const_cast<proto::ProtoSparseListIterator*>(attrs->getIterator(ctx));
                     while (it && it->hasNext(ctx)) {
                         fprintf(stderr, "    * Hash: %lu\n", (unsigned long)it->nextKey(ctx));
                         it = const_cast<proto::ProtoSparseListIterator*>(it->advance(ctx));
                     }
                 } else {
                     fprintf(stderr, "  - _collections_abc HAS NO ATTRIBUTES!\n");
                 }
             }
         }
         fflush(stderr);
    ...
    const proto::ProtoString* isSuperProxyS = PythonEnvironment::getInternedString(ctx, "__is_super_proxy__");
    ...
    if (val && val != PROTO_NONE) {
        if (!isClass) {
            ...
            if (obj->hasOwnAttribute(ctx, name) == PROTO_TRUE) {
                ...
                const proto::ProtoObject* mroObj = obj->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__mro__"));
                if (mroObj) {
    ...
    if (!val || (!isExplicitNone && val == PROTO_NONE)) {
        ...
        if (std::getenv("PROTO_ENV_DEBUG")) fprintf(stderr, "DEBUG_GET: searchObj=%p isClass=%d\n", (void*)searchObj, isClass);
        if (searchObj && searchObj != PROTO_NONE && (searchObj != obj || isClass)) {
            const proto::ProtoObject* mroObj = searchObj->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__mro__"));
            if (mroObj && mroObj != PROTO_NONE && mroObj->asList(ctx)) {
                ...
                if (mroList) {
                 ...
                 // Fallback to raw parents if __mro__ is missing or is a descriptor (common in bootstrap)
                 // CHECK searchObj ITSELF FIRST!
                 val = searchObj->proto::ProtoObject::getAttribute(ctx, name);
                 if (val && val != PROTO_NONE) {
                     foundOnClassOrMro = true;
                 } else {
                     ...
                     if (parents) {
                         for (size_t i = 0; i < parents->getSize(ctx); ++i) {
                             ...
                             // Recursive search in parents (since MRO is missing/descriptor)
                             val = this->getAttribute(ctx, baseCls, name);
                             if (val && val != PROTO_NONE) {
                                 foundOnClassOrMro = true;
                                 break;
                             }
    ...
    if (isClass && (!val || (!isExplicitNone && val == PROTO_NONE))) {
        const proto::ProtoObject* meta = this->getType(ctx, obj);
        if (std::getenv("PROTO_ENV_DEBUG")) fprintf(stderr, "DEBUG_GET: meta=%p for obj=%p\n", (void*)meta, (void*)obj);
        if (meta && meta != PROTO_NONE && meta != obj) {
            const proto::ProtoObject* mroObj = meta->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__mro__"));
            if (mroObj && mroObj != PROTO_NONE && mroObj->asList(ctx)) {
                const proto::ProtoList* mroList = mroObj->asList(ctx);
                if (mroList) {
                    if (std::getenv("PROTO_ENV_DEBUG")) fprintf(stderr, "DEBUG_GET: searching meta MRO (size %lu)\n", (unsigned long)mroList->getSize(ctx));
                    for (unsigned long i = 0; i < mroList->getSize(ctx); ++i) {
                        const proto::ProtoObject* baseCls = mroList->getAt(ctx, i);
                        val = baseCls->proto::ProtoObject::getAttribute(ctx, name);
                        if (std::getenv("PROTO_ENV_DEBUG")) fprintf(stderr, "  - meta MRO[%lu]: %p, val=%p\n", i, (void*)baseCls, (void*)val);
                        if (val && val != PROTO_NONE) {
                            foundOnClassOrMro = true;
                            break;
                        }
                 ...
                 // Metaclass MRO missing or descriptor, fallback to parents
                 // CHECK meta ITSELF FIRST!
                 ...
                 if (val && val != PROTO_NONE) {
                     ...
                     if (parents) {
                         for (size_t i = 0; i < parents->getSize(ctx); ++i) {
                             ...
                             // Recursive search for Bootstrap
                             val = this->getAttribute(ctx, baseCls, name);
                             if (val && val != PROTO_NONE) {
                                 foundOnClassOrMro = true;
                                 break;
...
// 1.5 Descriptor Protocol Check (__get__)
                 ...
                 if (isClass && foundOnClassOrMro) {
                     ...
                     if (owner && owner != PROTO_NONE) {
                          ...
                          if (mVal == val) {
                              ...
                              if (mValType && mValType->hasAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__set__")) == PROTO_TRUE) {
    ...
    if (!val && name) {
        ...
        if (attrStr == "update") {
            std::string clsName = "unknown";
            const proto::ProtoObject* cls = obj ? obj->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__class__")) : nullptr;
            if (cls) {
                 const proto::ProtoObject* n = cls->getAttribute(ctx, PythonEnvironment::getInternedString(ctx, "__name__"));
...
const proto::ProtoObject* PythonEnvironment::setAttribute(proto::ProtoContext* ctx, const proto::ProtoObject* obj, const proto::ProtoString* name, const proto::ProtoObject* value) {
    ...
    if (dataName && keysName && name != dataName && name != keysName) {
        // Use raw attribute access to avoid recursion and side effects during early bootstrap
        const proto::ProtoObject* d = obj->proto::ProtoObject::getAttribute(ctx, dataName);
        const proto::ProtoObject* k = obj->proto::ProtoObject::getAttribute(ctx, keysName);
...
const proto::ProtoObject* PythonEnvironment::resolveModule(const std::string& nameStr, proto::ProtoContext* ctx) {
    ...
    if (cached && cached != PROTO_NONE) {
        const proto::ProtoObject* result = cached->getAttribute(ctx, proto::ProtoString::fromUTF8(ctx, "val"));
...
const proto::ProtoObject* PythonEnvironment::initDictStorage(proto::ProtoContext* ctx, const proto::ProtoObject* obj) {
    ...
    const proto::ProtoObject* d = currentObj->proto::ProtoObject::getAttribute(ctx, dataName, false);
    const proto::ProtoObject* k = currentObj->proto::ProtoObject::getAttribute(ctx, keysName, false);
