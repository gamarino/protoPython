...
void generateMakefile(const fs::path& outRoot, const std::vector<fs::path>& sources) {
    ...
    outFile << "INCLUDES = -I/home/gamarino/Documentos/proyectos/protoPython/include -I/home/gamarino/Documentos/proyectos/protoCore/include\n";
    outFile << "LDFLAGS = -L/home/gamarino/Documentos/proyectos/protoPython/build/src/library -L/home/gamarino/Documentos/proyectos/protoPython/build/protoCore/src\n";
