...
> **`docs/archive/design-specs/2026-04-30-protopy-ground-truth-audit.md`**
>
...
`2026-05-13-test_descr-sweep-plan-round2.md` (internal planning note, not in the repository).
...
`2026-05-13-test_descr-sweep-plan.md` (internal planning note, not in the repository);
baseline measurement is anchored at
`test_descr_baseline_2026-05-13.md` (internal planning note, not in the repository).
...
Four deferred bugs catalogued during SP-C audit — see "Deferred bugs catalogued during SP-C" section of `docs/archive/design-specs/2026-04-30-protopy-ground-truth-audit.md`.
...
`docs/archive/design-specs/2026-04-25-test-grammar-coverage-design.md`)
