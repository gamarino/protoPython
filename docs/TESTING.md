...
- **test_execution_engine** (`build/test/library/test_execution_engine`): CTest for bytecode opcodes (e.g. BINARY_LSHIFT, INPLACE_SUBTRACT, BINARY_AND, INPLACE_MULTIPLY, INPLACE_TRUE_DIVIDE, INPLACE_MODULO, INPLACE_LSHIFT, INPLACE_AND, ROT_THREE, ROT_FOUR, DUP_TOP_TWO; see Next 20 Steps v24–v31).
