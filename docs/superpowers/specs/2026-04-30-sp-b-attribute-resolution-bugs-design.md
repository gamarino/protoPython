...
**Status:** PAUSED on 2026-04-30 mid-Task-4. Four of five symptoms closed (B5 NoneType, B1, B2, B3-via-SP-C, B4-via-SP-F); B3 was escalated to sub-project SP-C and closed by it — see `2026-04-30-sp-c-mappingproxy-semantics-design.md` (CLOSED on 2026-04-30); B4 was closed by SP-F.
...
SP-C, SP-D, SP-E and SP-F are closed; SP-B can resume from B5-reraise when work continues.
